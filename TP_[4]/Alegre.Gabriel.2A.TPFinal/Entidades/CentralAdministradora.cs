...
namespace Entidades
{
    public class CentralAdministradora : IArchivos<string>
    {
        ...
        public static event DelegadoEventos EventAvisadorQueClienteNoExiste;
        public static event DelegadoEventos EventAvisadorQueClienteExisteYEstaActivo;
        ...
        public static bool VerificarSiElClienteExisteYEstaActivoEnElSistema(int documunto)
        {
            ...
            if (BuscarClienteActivoPorDni(documunto) is not null)
            {
                ...
                EventAvisadorQueClienteExisteYEstaActivo.Invoke("Excelente, el dni que ingreso SI corresponde a un cliente existente y activo en el sistema");
            }
            else
            {
                throw new NoExisteClienteActivoConElDniIngresadoException("- No existe ningun cliente activo con el dni ingresado, si quiere, lo puede dar de alta");
            }
        ...
        public void Guardar(string ruta, string contenido)
        {
            ...
            {
                throw new FallaDeArchivoException("Upa, excepcion: Falla al querer guardar el archivo txt donde se encontrara el historial");
            }
        }
        ...
        public string Leer(string ruta)
        {
            ...
            {
                throw new FallaDeArchivoException("Upa, excepcion: Falla al querer leer el archivo txt del historial");
            }
        ...
        public void agregarCliente(Cliente unCliente)
        {
            ...
            { 
                throw new FallaDeArchivoException("Upa, excepcion: Hubo una falla al querer guardar el archivo txt del historial");
            }
        }
