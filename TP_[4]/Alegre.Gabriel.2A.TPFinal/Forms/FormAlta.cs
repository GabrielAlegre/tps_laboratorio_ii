...
namespace Forms
{
    public partial class FormAlta : Form
    {
        ...
        public FormAlta(CentralAdministradora centralDeServicios, int dniIngresado, EstadisticaServicios estadisticaDeLosServicios)
        {
            ...
            this.datosDelPlan = string.Empty;
        }
        ...
        {
            rtbDatosDelPlan.Text = datosDelPlan.MostrarPlan(EPlanElegido.PlanBasico);
        }
        ...
        {
            rtbDatosDelPlan.Text = datosDelPlan.MostrarPlan(EPlanElegido.PlanIntermedio);
        }
        ...
        {
            rtbDatosDelPlan.Text = datosDelPlan.MostrarPlan(EPlanElegido.PlanPremium);
        }
